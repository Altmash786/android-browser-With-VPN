...
import com.xitij.appbrowser.databinding.ItemCategoryproductBinding;
...
public class ProductCategoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ProductCategoryAdapter(List<CategoryRoot> categories, OnCategoryListnear onCategoryListnear) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case CONTENT_TYPE:
            default:
                View view1 = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_categoryproduct, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (getItemViewType(position) == AD_TYPE) {
            ...
            List<ProductRoot> apps = new ArrayList<>();
            myHolder.binding.tvCatName.setText(categories.get(position).getName());
            Log.d(TAG, "onBindViewHolder:catimage " + categories.get(position).getImage());
            db.collection("products").whereEqualTo("category_id", categories.get(position).getId())
                ...
                if (apps.size() == 0) {
                    ...
                    ProductAdapter appsAdapter = new ProductAdapter(apps);
    ...
    public void setAds(List<AdsRoot> advertisements) {
